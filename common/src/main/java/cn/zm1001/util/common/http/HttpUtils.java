...
public class HttpUtils {
    ...
    public static String doGetWithHeader(String url, Map<String, String> headerMap) {
        ...
        try (CloseableHttpClient httpClient = HttpClients.createDefault()) {
            ...
            log.info("#get# #rsp# #{}# {} {} {}", getUrl(url), url, JacksonUtils.toJson(headerMap), content);
        }
        return content;
    }
    ...
    public static String doPostXml(String url, String xml) {
        ...
        try (CloseableHttpClient httpClient = HttpClients.createDefault()) {
            ...
            log.info("#postXml# #rsp# #{}# {} {} {}", getUrl(url), url, xml, content);
        }
        return content;
    }
    ...
    public static String doPostWithHeader(String url, Map<String, String> headerMap, Map<String, Object> paramMap) {
        ...
        try (CloseableHttpClient httpClient = HttpClients.createDefault()) {
            ...
            log.info("#post# #rsp# #{}# {} {} {} {}", getUrl(url), url, JacksonUtils.toJson(headerMap), JacksonUtils.toJson(paramMap), content);
        }
        return content;
    }
    ...
    public static String doPostJsonWithHeader(String url, Map<String, String> headerMap, String json) {
        ...
        try (CloseableHttpClient httpClient = HttpClients.createDefault()) {
            ...
            log.info("#post# #rsp# #{}# {} {} {} {}", getUrl(url), url, JacksonUtils.toJson(headerMap), json, content);
        }
        return content;
    }
    ...
    public static String doPutWithHeader(String url, Map<String, String> headerMap, Map<String, Object> paramMap) {
        ...
        try (CloseableHttpClient httpClient = HttpClients.createDefault()) {
            ...
            log.info("#put# #rsp# #{}# {} {} {} {}", getUrl(url), url, JacksonUtils.toJson(headerMap), JacksonUtils.toJson(paramMap), content);
        }
        return content;
    }
    ...
    public static String doPutJsonWithHeader(String url, Map<String, String> headerMap, String json) {
        ...
        try (CloseableHttpClient httpClient = HttpClients.createDefault()) {
            ...
            log.info("#put# #rsp# #{}# {} {} {} {}", getUrl(url), url, JacksonUtils.toJson(headerMap), json, content);
        }
        return content;
    }
    ...
    public static String doDeleteWithHeader(String url, Map<String, String> headerMap) {
        ...
        try (CloseableHttpClient httpClient = HttpClients.createDefault()) {
            ...
            log.info("#delete# #rsp# #{}# {} {} {}", getUrl(url), url, JacksonUtils.toJson(headerMap), content);
        }
        return content;
    }
    ...
    public static String doDeleteWithBody(String url, Map<String, String> headerMap, Map<String, Object> paramMap) {
        ...
        try (CloseableHttpClient httpClient = HttpClients.createDefault()) {
            ...
            log.info("#delete# #rsp# #{}# {} {} {} {}", getUrl(url), url, JacksonUtils.toJson(headerMap), JacksonUtils.toJson(paramMap), content);
        }
        return content;
    }
    ...
    public static String doDeleteJsonWithBody(String url, Map<String, String> headerMap, String json) {
        ...
        try (CloseableHttpClient httpClient = HttpClients.createDefault()) {
            ...
            log.info("#delete# #rsp# #{}# {} {} {} {}", getUrl(url), url, JacksonUtils.toJson(headerMap), json, content);
        }
        return content;
    }
