package cn.zm1001.util.common.html;
...
public final class HtmlFilter {
    ...
    public HtmlFilter() {
        ...
        final List<String> a_attrs = new ArrayList<>();
        a_attrs.add("href");
        a_attrs.add("target");
        vAllowed.put("a", a_attrs);

        final List<String> img_attrs = new ArrayList<>();
        img_attrs.add("src");
        img_attrs.add("width");
        ...
        final List<String> no_attrs = new ArrayList<>();
